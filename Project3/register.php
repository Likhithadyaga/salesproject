    ...
    <nav aria-label="breadcrumb"
      ...
      <ol class="breadcrumb" style="background-color: #5D6D7E;">
        <li class="breadcrumb-item"><a href="index.html"
            style="color: white; text-decoration: none; font-weight: 600;  ">Registration Page</a></li>
      </ol>
    </nav>
  </section>
  <br>
...
<br>
 ...
 <div class="form-group row">
            <label for="text" class="col-sm-2 col-form-label" style="margin-left:13%">Name</label>
            <div class="col-sm-6">
          ...
          <br>
          <div class="form-group row">
            <label for="text" class="col-sm-2 col-form-label" style="margin-left:13%">Email</label>
            <div class="col-sm-6">
